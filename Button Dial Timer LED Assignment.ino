...
//Explanation: to get the countdown effect working for the 4 LEDs each LED must turn on at 4 intervals. specifically, when 100% of the timer remains, when 75% remains, 50% remains, 25%, and lastly 0%.
//
//Example: 2000ms millis & dial set to 5000ms. all the LEDs will turn off once millis reaches 7000ms. there are 4 LEDs so we divide the dial time by 4 (5000/4 = 1000). immediately after pressing button, blue LED is lit. 
